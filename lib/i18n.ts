...
const dict: Record<string, Record<Lang, string>> = {
  ...
  'page.forestry.site-index.sub': { ko: '산림 부문 · 국가별 지위지수 (Siteindex_m, m)', en: 'Forestry · Site Index by country (Siteindex_m, m)', zh: '林业 · 各国立地指数 (Siteindex_m, m)', ja: '林業 · 国別地位指数 (Siteindex_m, m)' },
